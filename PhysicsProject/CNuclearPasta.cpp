...
CNuclearPasta::CNuclearPasta(sf::Vector2f _v2fPosition, float _fScale, b2World* _pWorld)
{
	m_EGameObjectType = EGAMEOBJECTTYPE::NUCLEARPASTA;

	// Set the sprite
	m_texture.loadFromFile("Resources/Sprites/Pasta.png");
